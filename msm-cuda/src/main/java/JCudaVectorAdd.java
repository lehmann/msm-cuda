...
/**
 * This is a sample class demonstrating how to use the JCuda driver bindings to
 * load and execute a CUDA vector addition kernel. The sample reads a CUDA file,
 * compiles it to a PTX file using NVCC, loads the PTX file as a module and
 * executes the kernel function. <br />
 */
public class JCudaVectorAdd {
	...
	public static void main(String args[]) throws IOException {
		...
		String ptxFileName = preparePtxFile("C:/Users/André/workspace/dtw-cuda/target/classes/JCudaVectorAddKernel.cu");
